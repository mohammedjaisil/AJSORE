...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$supabase$2d$adapter$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@auth/supabase-adapter/index.js [app-route] (ecmascript)");
...
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    adapter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$supabase$2d$adapter$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseAdapter"])({
        url: ("TURBOPACK compile-time value", "https://pgagzknsmwdskadmcgqy.supabase.co"),
        secret: process.env.SUPABASE_SERVICE_ROLE_KEY
    }),
    providers: [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$google$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            authorize: async (credentials)=>{
                ...
                if (parsedCredentials.success) {
                    ...
                    const { data: user } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('users').select('*').eq('email', email).single();
    ...
    callbacks: {
        ...
        async jwt ({ token, user }) {
            ...
            if (token.sub && !token.role) {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('users').select('role').eq('id', token.sub).single();
                if (data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f308ba01._.js.map