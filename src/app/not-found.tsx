...
export default function NotFound() {
    return (
        <div className="max-w-7xl mx-auto px-4 py-32 text-center space-y-6">
            ...
            <Link href="/" className="inline-block bg-[#005d32] text-white px-10 py-4 rounded-full font-bold uppercase text-xs tracking-widest shadow-xl shadow-[#005d32]/20 btn-haptic">
                Back to Base
            </Link>
        </div>
    );
